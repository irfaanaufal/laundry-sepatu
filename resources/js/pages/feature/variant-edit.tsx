...
import { Feature, Variant, type BreadcrumbItem } from '@/types';
...
export default function EditFeatureVariantPage({
        title,
        feature,
        variant
    }: {
    ...
    const breadcrumbs: BreadcrumbItem[] = [
        ...
        {
            title: 'Edit Variant',
            href: `/feature/${feature.id}/variant/${variant.id}/edit`,
        },
    ];
    ...
    const onSubmit = async (data: FeatureFormValue) => {
        ...
        try {
            ...
            const response = await axios.post(route('feature.variant.update', { feature: feature.id, variant: variant.id }), newData, {
                headers: {
