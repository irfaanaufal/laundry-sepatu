...
export default function CreateFeatureVariantPage({
        title,
        feature
    }: {
        title: string;
    ...
    const breadcrumbs: BreadcrumbItem[] = [
        ...
        },
        {
            ...
            href: `/feature/${feature.id}/variant/create`,
        },
    ];
    ...
    const onSubmit = async (data: FeatureFormValue) => {
        // console.log(data);
        try {
            const response = await axios.post(route('feature.variant.store', { feature: feature.id }), data, {
                headers: {
            ...
            <div className="flex h-full flex-1 flex-col gap-4 rounded-xl p-4">
                <div className="border-sidebar-border/70 dark:border-sidebar-border relative min-h-[100vh] flex-1 overflow-hidden rounded-xl border md:min-h-min p-3">
                    <div className="w-auto lg:w-1/2 md:w-3/4">
                        <h1 className='font-extrabold text-xl mb-3'>Feature Variant Create Form</h1>
                        <Form {...featureForm}>
                            <form onSubmit={featureForm.handleSubmit(onSubmit)} className="space-y-8">
                                <FormField
                                    ...
                                    render={({ field }) => (
                                        <FormItem>
                                            ...
                                            <FormControl>
                                                <Input placeholder="input feature variant names" {...field} />
                                            </FormControl>
                                            <FormDescription>
                                                This is feature variant public display name.
                                            </FormDescription>
                                            <FormMessage />
                                        </FormItem>
                                    )}
                                ...
                                <FormField
                                    ...
                                    render={({ field: { value, ...fieldProps } }) => (
                                        <FormItem>
                                            <FormLabel>Feature Variant Description</FormLabel>
                                            <FormControl>
                                                <ReactQuill {...fieldProps} theme="snow" value={value} className="mb-[2.5rem]" />
                                            </FormControl>
                                            <FormDescription>
                                                This is feature variant public display description.
                                            </FormDescription>
                                            <FormMessage />
                                        </FormItem>
                                    )}
                                ...
                                <FormField
                                    ...
                                    render={({ field }) => (
                                        <FormItem>
                                            ...
                                            <FormDescription>
                                                This is feature variant public display price.
                                            </FormDescription>
                                            <FormMessage />
                                        </FormItem>
                                    )}
